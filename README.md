...
settings.py находятся данные об эл.почте и пароле, адресе сайта и пути до веб-драйвера: drv_path = '../../ChromeDrv/chromedriver.exe' Перед запуском тестирования надо указать свой путь до веб-драйвера.
Для запуска необходимо установить библиотеки pytest и pytest-selenium и выполнить команду pytest -v -s tests/ из корня проекта.
